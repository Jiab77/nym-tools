...
# nym-socks5-client service install script
# Made by Jiab77
#
...
DEBUG_MODE=true
INSTALL_USER="nym"
INSTALL_SERVICE="nym-socks5-client.service"
...
if [[ $DEBUG_MODE == true ]]; then
    ...
    cat <<EOF
[Unit]
Description=Nym Socks5 Client (1.0.2)
...
EOF
    ...
    if [[ $(ss -tunel | grep -c 1080) -ne 0 ]]; then
        echo -e "\nYou should be able now to configure your clients to connect to your local Nym Socks5 client that way:\n- Host: localhost\n- Port: 1080\n"
    fi
fi
