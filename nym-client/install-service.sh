...
# nym-client service install script
# Made by Jiab77
#
...
DEBUG_MODE=true
INSTALL_USER="nym"
INSTALL_SERVICE="nym-client.service"
...
LimitNOFILE=65536
ExecStart=$INSTALL_PATH/nym-client run --id $CLIENT_ID # remember to check the path to your nym-client binary and the id of your client 
KillSignal=SIGINT
Restart=on-failure
RestartSec=30
